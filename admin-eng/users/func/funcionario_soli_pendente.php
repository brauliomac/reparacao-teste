                            ...
                            if($result->num_rows > 0){
                                ...
                                while($row = $result->fetch_assoc()){
                                    echo "<tr>
                                            ...
                                            <td>
                                                <a href='atribuir_tecnico.php?id={$row['id']}' class='btn btn-sm btn-primary'>Aprovar</a>
                                                <a href='atribuir_tecnico.php?id={$row['id']}' class='btn btn-sm btn-danger'>Rejeitar</a>
                                            </td>
                                        </tr>";
                                }
                                echo '</table>';
