...
$sql = "SELECT * FROM users WHERE papel = 'cliente' ORDER BY name";
...
<div class="container">
    ...
    <a href="funcionario_add_cliente.php" class="btn btn-success mb-3">Adicionar cliente</a>
                ...
                <?php while($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="funcionario_apagar_cliente.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"
