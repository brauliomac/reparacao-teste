            ...
            <div class="col-md-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <?php
                        $sql = "SELECT r.*, u.name AS cliente_name FROM pedidos r JOIN users u ON r.cliente_id = u.id WHERE r.tecnico_id = $tecnico_id AND r.status = 'montado' ORDER BY r.data_criacao ASC";
