...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($sql)) {
        header("Location: funcionario_ver_clientes.php");
        exit;
    } else {
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title"> Remover Cliente</div>
                  </div>
                  <div class="card-body">
                    <div class="chart-container">
                        ...
                        <form method="post" action="funcionario_apagar_cliente.php">
                            ...
                            <a href="funcionario_ver_clientes.php" class="btn btn-secondary">Cancelar</a>
                        </form>
                    </div>
                  </div>
                </div>
