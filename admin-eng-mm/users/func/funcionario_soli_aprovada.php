                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="chart-container">
                        <?php
                            // Consulta melhorada para mostrar todas as solicitações em andamento
                            $sql = "SELECT 
                                        p.*, 
                                    ...
                                    WHERE p.status IN ('atribuido', 'diagnosticado') 
                                    ORDER BY 
                                        FIELD(p.prioridade, 'alta', 'media', 'baixa'),
                                        p.data_actualizacao DESC";
