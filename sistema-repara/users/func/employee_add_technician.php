...
<body>
<div class="container">
    <h2 class="mt-5">Adicionar Tecnico</h2>
    <?php if ($error) echo "<div class='alert alert-danger'>$error</div>"; ?>
    <?php if ($success) echo "<div class='alert alert-success'>$success</div>"; ?>
    <form method="post" action="employee_add_technician.php">
    ...
    <a href="employee_view_technicians.php" class="btn btn-secondary mt-3">Voltar</a>
</div>
</body>
</html>
