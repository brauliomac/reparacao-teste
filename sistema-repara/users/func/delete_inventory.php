...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $sql = "DELETE FROM inventory WHERE id = $component_id";
...
<div class="container">
    ...
    <?php endif; ?>
    <p>Tem certeza que deseja apagar o componente <strong><?php echo htmlspecialchars($componentData['component']); ?></strong>?</p>
