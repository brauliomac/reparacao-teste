...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($conn->query($sql)) {
        header("Location: employee_view_clients.php");
        exit;
    } else {
...
<div class="container">
    ...
    <form method="post" action="employee_delete_client.php">
        <input type="hidden" name="id" value="<?php echo $userData['id']; ?>">
        <button type="submit" class="btn btn-danger">Sim, remover</button>
        <a href="employee_view_clients.php" class="btn btn-secondary">Cancelar</a>
    </form>
</div>
</body>
</html>
