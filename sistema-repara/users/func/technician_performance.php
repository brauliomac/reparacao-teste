<?php
session_start();
// Apenas usuários com perfil 'employee' podem acessar esta página
...
$sql = "SELECT 
            ...
            AVG(TIMESTAMPDIFF(MINUTE, r.created_at, r.updated_at)) AS avg_completion_time
        FROM requests r
...
<div class="container">
    ...
    <a href="reports.php" class="btn btn-secondary">Voltar ao Relatório</a>
</div>
</body>
</html>
